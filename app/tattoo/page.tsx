...
export default function Page(){
  return <UseCasePage
    ...
    imageBandBody="The old page had the right instinct: tattoos do not stop needing skin care when the peeling ends. Consistent moisture can make dry, ashy surface texture look smoother, which lets healed ink read more clearly. That is cosmetic care—not a promise to restore pigment that has actually faded."
