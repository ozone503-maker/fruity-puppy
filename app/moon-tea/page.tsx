...
export default function Page() {
  return (
    <InnerPage
      ambientAudio={{ src: "/audio/moon-tea-ambience.mp3", triggerSelector: "#inner-story" }}
      heroVideo={{
        src: "/images/process/moon-tea/spearmint-harvest.mp4",
        poster: "/images/process/moon-tea/spearmint-harvest-poster.jpg",
        label: "Harvesting spearmint for Moon Tea at FlashTown",
      }}
      data={{
        eyebrow: "nocturnal polishing potion",
        title: "Thorny Toad Moon Tea",
        intro:
          "A fresh botanical toner brewed for the quiet work your skin does at night.",
        hero: "/images/new/moon-tea.png",
        heroAlt: "Thorny Toad Moon Tea artwork",
        sections: [
          {
        ...
        cta: { label: "Shop Moon Tea", href: "https://shop.fruitypuppy.com" },
      }}
    />
  );
}
